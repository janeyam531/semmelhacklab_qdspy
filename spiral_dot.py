...
class SpiralDot:
    ...
    def __init__(self, width=4, height=20,
                 #width and height defines the size of the object
                 azimuth=0, altitude=0,
                 circulation_frequency=1., circulation_anticlockwise=True, initial_circulation_angle=0.,
                 #cir_frequency: for speed of rotation
                 circulation_radius=30., #size of the circle it makes
                 rotation_frequency=1, rotation_anticlockwise=None, initial_rotation_angle=None,
                 #rotation_frequency: rotation of the object as it moves around the circulation
    ...
    def init(self):
        QDS.DefObj_Ellipse(self.id, self._w, self._h) #shape define widtha and height
...
# Main script
# --------------------------------------------------------------------------
QDS.Initialize("SpiralingDot", "spiraling dot")
...
QDS.Loop(n_trials, SpiralingDotSequence)
